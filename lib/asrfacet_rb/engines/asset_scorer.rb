  ...
  module Engines
    class AssetScorer
      SCORE_RULES = [
        ...
        { label: "Missing HSTS", condition: ->(asset) { asset.dig(:security_headers, "Strict-Transport-Security") == false }, score: 10 },
        { label: "Missing CSP", condition: ->(asset) { asset.dig(:security_headers, "Content-Security-Policy") == false }, score: 10 },
