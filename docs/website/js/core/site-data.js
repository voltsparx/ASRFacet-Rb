const DocsData = (() => {
  ...
  const entries = [
    ...
    { id: "download-usage", title: "Installer Usage", page: "download.html", hint: "Install, test, update, uninstall, and wrapper-driven local deployment flows.", group: "Downloads" },
    ...
    { id: "commands", title: "Commands", page: "cli-reference.html", hint: "Primary scan, scanner, workspace, deployment, and report commands.", group: "Operators" },
    { id: "flags", title: "Global Flags", page: "cli-reference.html", hint: "Cross-command switches, raw-scan controls, throttling, and output controls.", group: "Operators" },
    { id: "syntax", title: "Syntax Guide", page: "cli-reference.html", hint: "Command grammar, examples, operator shorthand, and realistic command shapes.", group: "Operators" },
    ...
    { id: "outputs", title: "Output Formats", page: "reporting.html", hint: "CLI, TXT, HTML, JSON, CSV, PDF, DOCX, SARIF, and when to use each.", group: "Reports" },
