...
assert(version_output == expected_version, "Expected version #{expected_version}, got #{version_output.inspect}.")

alias_version = run_command(*ruby_command("bin/asrfrb", "version")).strip
assert(alias_version == expected_version, "Expected alias version #{expected_version}, got #{alias_version.inspect}.")
